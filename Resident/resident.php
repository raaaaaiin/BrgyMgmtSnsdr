...
echo'
<button type="button" class="btn btn-primary clg-offset-10" data-toggle="modal" data-target="#myModal"   >Add resident
  ...
  <div class="modal-dialog" style="width:800px;" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel" style="text-align: center; font-style: normal;font-size: 18px;font-family: Verdana">RESIDENT INFORMATION (title)</h4>
      </div>
 ===================================================================================================================================================
