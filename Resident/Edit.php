...
<br><br>
       ...
       <button type="button" onclick="location.href='resident.php'" class="btn btn-danger  clg-offset-5"><span class="glyphicon glyphicon-home" aria-hidden="true"></span> Back</button>
