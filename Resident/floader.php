...
$muser_id=$user_id;
    ...
    echo "<script type='text/javascript'>alert('submitted successfully!')</script>";
        ...
        <br>
       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <button type="button" class="btn btn-danger clg-offset-0" onclick="location.href = 'resident.php';"  >Back
...
<div class="cls-5 col-xs-6 tital " >Occupation Status:</div><div class="cls-4"><?php echo $db_res_ocst;?></div><div class="clearfix"></div>
<div class="bot-border"></div>
