...
?>
        ...
        <br>
       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <button type="button" class="btn btn-primary clg-offset-0" onclick="location.href = 'resident.php';"  >Back
...
<div class="cls-5 col-xs-6 tital " >Contact No.:</div><div class="cls-7"><?php echo isset($db_res_cnum);?></div>
...
<div class="cls-5 col-xs-6 tital " >Mother:</div><div class="cls-7"><?php echo $db_mother_fName." ".$db_mother_mName." ".$db_mother_lName;?></div>
...
<div class="cls-5 col-xs-6 tital " >Father:</div><div class="cls-7"><?php echo $db_father_fName." ".$db_father_mName." ".$db_father_lName;?></div>
    
               
                
                 
<div id="signup">
<button type="button" class="btn btn-primary clg-offset-10" id="signup"  name="signup">Status
  <span class="glyphicon glyphicon-minus" aria-hidden="true"></span>
    ...
    <input type="hidden" maxlength="20" class="form-control" id="dethId" name="deathId" value="<?php echo $user_id;?>">
        ...
        <br>
        <div required class="clg-offset-1 form-group clm-5">
