...
?>
        ...
        <br>
       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <button type="button" class="btn btn-success clg-offset-0" onclick="location.href = 'resident.php';"  >Back
...
<div class="cls-5 col-xs-6 tital " >Sex:</div><div class="cls-7 col-xs-6 "><?php echo  $db_res_gen;?></div>
     <div class="clearfix"></div>
<div class="bot-border"></div>

<div class="cls-5 col-xs-6 tital " >Birthday:</div><div class="cls-7"> <?php echo $db_res_bdate;?></div>
  <div class="clearfix"></div>
<div class="bot-border"></div>

<div class="cls-5 col-xs-6 tital " >Age:</div><div class="cls-7" > <?php echo $age;?> </div>
  <div class="clearfix"></div>
<div class="bot-border"></div>



<div class="cls-5 col-xs-6 tital " >Civil Status:</div><div class="cls-7"><?php echo $db_res_mstat;?></div>
...
<div class="cls-5 col-xs-6 tital " >Religion:</div><div class="cls-7"><?php echo $db_res_rel;?></div>
        
        <div class="clearfix"></div>
<div class="bot-border"></div>

<div class="cls-5 col-xs-6 tital " >Height:</div><div class="cls-7 col-xs-6 "><?php echo  $db_res_height;?></div>
     <div class="clearfix"></div>
<div class="bot-border"></div>

<div class="cls-5 col-xs-6 tital " >Weight:</div><div class="cls-7 col-xs-6 "><?php echo  $db_res_weight;?></div>
     <div class="clearfix"></div>
<div class="bot-border"></div>

<div class="cls-5 col-xs-6 tital " >Citizenship:</div><div class="cls-7"><?php echo $db_res_citi;?></div>
        
        <div class="clearfix"></div>
<div class="bot-border"></div>

<div class="cls-5 col-xs-6 tital " >Contact No.:</div><div class="cls-7"><?php echo $db_res_cnum;?></div>
        
        <div class="clearfix"></div>
<div class="bot-border"></div>

<div class="cls-5 col-xs-6 tital " >Address:</div><div class="cls-7"><?php echo $db_res_unit .", ".$db_res_build.", L".$db_res_lot.", BLK".$db_res_block.", PH".$db_res_phase.", ".$db_res_house .", ".$db_res_street." Street, ".$db_res_sub.", ".$db_res_pur." , San isidro, Antipolo Rizal";?></div>
        
        <div class="clearfix"></div>
<div class="bot-border"></div>

<div class="cls-5 col-xs-6 tital " >Occupation Status:</div><div class="cls-7"><?php echo $db_res_ocst;?></div><div class="clearfix"></div>
<div class="bot-border"></div>

<div class="cls-5 col-xs-6 tital " >Occupation:</div><div class="cls-7"><?php echo $db_res_occ;?></div>
...
<div class="panel panel-default">
   ...
   <div class="r-bttn" >
       <button type="button" onclick="location.href='resident-select-mother.php'" id="show_button" class="btn btn-success btn-sm clg-offset-4">
  Select Mother
</button>
<br>
...
<div class="cls-5 col-xs-6 tital " >Name:</div><div class="cls-7"> </div>
    
            <div class="clearfix"></div>
<div class="cls-5 col-xs-6 tital " >Contact Number :</div><div class="cls-7"> </div>
            
            
            
            <div class="clearfix"></div>
<div class="cls-5 col-xs-6 tital " >Gender :</div><div class="cls-7"> </div>
            
            <div class="clearfix"></div>
<div class="cls-5 col-xs-6 tital " >Occupation :</div><div class="cls-7"> </div>
