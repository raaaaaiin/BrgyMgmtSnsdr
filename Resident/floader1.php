...
<div class="cls-5 col-xs-6 tital " >Name:</div><div class="cls-7"><?php echo $M_fName ." ".$M_mName." ".$M_lName ;?> </div>
    
            <div class="clearfix"></div>
<div class="cls-5 col-xs-6 tital " >Contact Number :</div><div class="cls-7"><?php echo $M_contact ;?> </div>
