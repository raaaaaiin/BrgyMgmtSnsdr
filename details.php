...
<html>
  ...
  <body style="">
      ...
      <section class="blog-posts" style="margin-top:150px">
      <div class="cont">
        <div class="r">
          <div class="clg-8">
               ...
               <div class="clg-12">
                  <div class="blog-post">
                    <div class="blog-thumb">
                      <img style="image-rendering: pixelated;width:730;height:400px;background: url(Communication/<?php echo $r["image"]?>); background-size: cover;
                ...
                <div class="clg-12">
                  <div class="sidebar-item recent-posts">
                    ...
                    <div class="content">
                      <ul>
                      <?php
                       $res = mysqli_query($db, "SELECT * FROM announce ORDER BY date DESC LIMIT 3");
                           while ($r = mysqli_fetch_assoc($res))
                           { ?>
