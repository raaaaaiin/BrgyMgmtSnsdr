...
<body>
 ...
 <nav class="navtop navigationtop navigationtop-default navigationtop-fixed-top" style="box-shadow: inset 0px -2px 1px rgb(0 0 0 / 4%), inset 0px -1px 1px rgb(0 0 0 / 0%)">
          ...
          <ul class="navigationtop-nav navtopul" style="font-size:16px">
            ...
            include('db.php');
             ...
             <li class="navtopli" style=""><a href = "accountLogout.php" target="_Parent" class="navlabel" style="">Log Out</a></li>';
 		        ...
 		        echo '<li class="navtopli" style=""><a href="#" class="navlabel" style="">Log In</a></li>';
 	           }
            ?>
            </li>
          </ul>
